...
Season_2020 = pd.read_excel(r"https://football-data.co.uk/mmz4281/2021/all-euro-data-2020-2021.xlsx", sheet_name=None)
...
Season93_20 = pd.read_csv(r"C:\Users\harsh\Documents\My Dream\Desktop\Betting\Files\dataset(1993-2019).csv",
                          low_memory=False)
...
print("Saving csv")
db_concat.to_csv(r"C:\Users\harsh\Documents\My Dream\Desktop\Betting\Files\dataset_updated.csv")
print("File Saved")
print("Success")
end = datetime.now()
